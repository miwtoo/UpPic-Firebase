...
var AppComponent = /** @class */ (function () {
    function AppComponent(storage) {
        ...
        var ref = this.storage.ref('test/');
        console.log(ref);
    }
    AppComponent.prototype.uploadFile = function (event) {
        var _this = this;
        var file = event.target.files[0];
        var filePath = "test/" + new Date().getTime() + "_" + file.name;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [{ provide: _angular_fire_storage__WEBPACK_IMPORTED_MODULE_6__["StorageBucket"], useValue: 'gs://uppictest.appspot.com/' }],
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyCMljaHR9Z5ekdwHq1bMpQdNL8EjEIbPXk",
        authDomain: "uppictest.firebaseapp.com",
        databaseURL: "https://uppictest.firebaseio.com",
        projectId: "uppictest",
        storageBucket: "uppictest.appspot.com",
        messagingSenderId: "949335329645"
    }
};
...
module.exports = __webpack_require__(/*! D:\User profile\Documents\GitHub\UpPic-Firebase\src\main.ts */"./src/main.ts");
